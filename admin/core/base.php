...
function load_model($model, $modules ="") {
    if (empty($modules)) {
        $path = MODULESPATH . DIRECTORY_SEPARATOR . get_module() . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . $model . 'Model.php';
    }  else {
         $path = MODULESPATH . DIRECTORY_SEPARATOR . $modules . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . $model . 'Model.php';

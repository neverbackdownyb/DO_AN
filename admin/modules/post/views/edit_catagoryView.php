            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" action="" enctype="multipart/form-data" id="form-upload-single">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo $catagory_post['catagory'] ; ?>">
                        <label>Danh mục cha</label>
                        <select name="parent_cat">
                            <option value="0">-- Chọn danh mục --</option>
                            <?php foreach ($list_catagory as $item_select) { ?>
                            <option <?php selected($catagory_post['parent_id'], $item_select['id'])?> value="<?php echo $item_select['id'] ?>"> <?php echo str_repeat('----', $item_select['level']) . $item_select['catagory'] ?></option>
                            <?php } ?>
                        </select>

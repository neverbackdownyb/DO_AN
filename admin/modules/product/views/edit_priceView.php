...
<div id="main-content-wp" class="add-cat-page menu-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            ...
            <h3 id="index" class="fl-left">Chỉnh sửa khoảng giá </h3>
                ...
                <div id="list-menu" class="fl-left">
                    <form  method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="<?php echo $price['title'] ?>">
                            <p style="color: red"><?php form_error('title') ?></p>
                        </div>
                        
                        <div class="form-group">
                            <label for="order_num">Thứ tự</label>
                            <input type="text" name="order_num" id="menu-order" value="<?php echo $price['order_num'] ?>" >

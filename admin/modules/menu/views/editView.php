                ...
                <div id="list-menu" class="fl-left">
                    <form  method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="<?php echo $menu['title']?>">
                        </div>

                        <p style="color: red"><?php form_error('title') ?></p>
                        <div class="form-group">
                            <label for="url-static">Đường dẫn tĩnh</label>
                            <input type="text" name="url_static" id="url-static" value="<?php echo $menu['static_link'] ?> ">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <select name="product_id">
                                ...
                                <?php foreach ($catagory_product as $item) { ?>
                                    <option <?php selected($item['id'], $menu['id_connect'])?>  value="<?php echo $item['id']; ?>"><?php
                        ...
                        <div class="form-group clearfix">
                            ...
                            <select name="post_id">
                                <option value="0">-- Chọn --</option>
                                    ...
                                    <option <?php selected($item['id'], $menu['id_connect'])?>  value="<?php echo $item['id']; ?>"><?php echo str_repeat('----', $item['level']);echo $item['catagory'];?></option>
<?php } ?>
                            </select>
                            <p style="color: red"> <?php form_error('empty') ?> </p>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <select name="parent_id">
                                ...
                                <option <?php selected($item['id'], $menu['parent_id'])?> value="<?php echo $item['id']; ?>"><?php echo str_repeat('--', $item['level']) . $item['title']; ?></option>
                                <?php } ?>
                            </select>
                            <p>Danh mục sản phẩm liên kết đến menu</p>
                        </div>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <select name="type_menu">
                                ...
                                <option <?php selected($item['id'],$menu['id_type_menu'])?> value="<?php echo $item['id'] ?>"><?php echo $item['type_menu'];?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="menu_order" id="menu-order" value="<?php echo $menu['order_num'] ;?>">
                            <p style="color: red"><?php form_error('menu_order') ?></p>
                        </div>


                        <div class="form-group">
                            <button type="submit" name="sm_add" id="btn-save-list">Cập nhật</button>
                        </div>
                    </form>
                </div>

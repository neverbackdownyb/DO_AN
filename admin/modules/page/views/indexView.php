            ...
            <div class="section" id="detail-page">
                ...
                <div class="filter-wp clearfix">
                    <ul class="post-status fl-left">
                        <li class="all"><a href="?mod=page&controller=index&action=index">Tất cả <span class="count">(<?php echo get_number_page(''); ?>)</span></a> |</li>
                        <li class="publish"><a href="?mod=page&controller=index&action=index&status=active">Đã đăng <span class="count">(<?php echo get_number_page('active'); ?>)</span></a> |</li>
                        <li class="pending"><a href="?mod=page&controller=index&action=index&status=pendy">Chờ xét duyệt <span class="count">(<?php echo get_number_page('pendy'); ?>)</span></a> |</li>
                        <li class="trash"><a href="?mod=page&controller=index&action=index&status=bin">Thùng rác <span class="count">(<?php echo get_number_page('bin'); ?>)</span></a></li>
                    ...
                    <form method="GET" class="form-s fl-right">
                        ...
                        <input type="text" name="search" id="s" placeholder="Tên trang ...">
                        <input type="submit" name="sm_s" value="Tìm kiếm">
                    </form>
                </div>

                <div class="actions">
                    <form method="POST" action="?mod=page&controller=index&action=task" class="form-actions">
                        <select name="actions">

        ...
        <div id="content" class="fl-right">                       
            <div class="section" id="detail-page">
                <form method="GET" class="form-s fl-right">
                    <input type="hidden" name="mod" value="slide"id="s">
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="?mod=slide&controller=index&action=index">Tất cả <span class="count">(<?php echo get_num_slider('') ?>)</span></a> |</li>
                            <li class="publish"><a href="?mod=slide&controller=index&action=index&status=active">Đã đăng <span class="count">(<?php echo get_num_slider('active') ?>)</span></a> |</li>
                            <li class="pending"><a href="?mod=slide&controller=index&action=index&status=pendy">Chờ xét duyệt <span class="count">(<?php echo get_num_slider('pendy') ?>)</span></a> |</li>
                            <li class="trash"><a href="?mod=slide&controller=index&action=index&status=bin">Thùng rác <span class="count">(<?php echo get_num_slider('bin') ?>)</span></a></li>
                        </ul>
                    </div>

                    <div class="actions">
                        <form method="POST" action="?mod=slide&controller=index&action=task" class="form-actions">
                            <select name="actions">
                                            ...
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    <div class="tb-title fl-left">
                                                        <a href="" title=""><?php echo $item['capture']; ?></a>
                                                    </div>
                                                </td>
                                                <td>
